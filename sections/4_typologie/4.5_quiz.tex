...
\begin{frame}{Q1}
    ...
    \note{
        Réponse : clé-valeur, colonne, document et graphe.
        Les autres propositions mélangent formats, modèles ou technologies
        qui ne constituent pas les quatre familles retenues ici.
    }
...
\begin{frame}{Q2}
    ...
    \note{
        Réponse : JSON ou BSON. Le document peut aussi être représenté dans
        d'autres formats selon le produit, mais JSON et BSON sont les exemples
        principaux à retenir pour ce cours.
    }
...
\begin{frame}{Q3}
    ...
    \note{
        Réponse : Neo4j. Le critère déterminant est la présence de relations
        et de parcours dans le graphe, pas simplement le volume de données.
    }
...
\begin{frame}{Q4}
    ...
    \note{
        Réponse : base orientée document. Les possessions ont une structure
        évolutive, les catégories peuvent augmenter et les informations peuvent
        être imbriquées dans le document du joueur.
    }
...
\begin{frame}{Q5}
    ...
    \note{
        Réponse : base clé-valeur. Les objets sont retrouvés par une clé connue
        et le contenu JSON n'a pas besoin d'être interrogé. C'est exactement
        le cas d'usage d'un accès direct et très rapide.
    }
...
\begin{frame}{Q6}
    ...
    \note{
        Réponse : base orientée document. Les recherches portent sur plusieurs
        attributs internes du JSON, ce qui nécessite que la base comprenne
        et indexe la structure du document.
    }
