...
\begin{frame}{Cas d'usage}
    ...
    Camille Lemoine est propriétaire d'une chaîne de trois restaurants situés à Paris, Londres et Dublin. Elle souhaite stocker les données de ses client$\cdot$es dans une base de données en fonction de ses différents restaurants.
    ...
    Elle vous demande de l'aider à choisir la meilleure stratégie de partitionnement pour stocker les données de ses client$\cdot$es en fonction de leur localisation.
